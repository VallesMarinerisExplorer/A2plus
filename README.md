...
1. Writing new joints into a Universal Robot Definition File (URDF) that can be used by PyBullet, which is a physics and robotics framework that may have better performance than the current A2Plus solver.
